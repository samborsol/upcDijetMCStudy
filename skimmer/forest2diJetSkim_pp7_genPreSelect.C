...
void forest2diJetSkim_pp7_genPreSelect(
	...
	TFile *newfile = new TFile("data/skimmedFiles/genPreSelect_mult.root","recreate");
...
//		if(numjt == 2){
			...
			if(pt[0] > 20 && pt[1] > 15 && totaljtvec.M() > 35 && abs(eta[0])<1.8 && abs(eta[1])<1.8 && d_phi>2)
			{
